...
if (
    ...
    || !array_key_exists('extractionFields', $payload)
    || !is_array($payload['extractionFields'])
) {
...
$normalized = [
    ...
    'extractionFields' => normalize_extraction_fields($payload['extractionFields']),
];
...
try {
    ...
    json_response([
        ...
        'extractionFields' => $normalized['extractionFields'],
    ]);
} catch (Throwable $e) {
